...
class IdSetImp
    : public Dune::IdSet<const TriangleGrid, IdSetImp, unsigned int> {

public:
  typedef unsigned int IdType;

  template <int cd>
  IdType id(const typename TriangleGrid::GridFamily::Traits::Codim<cd>::Entity
                &entity) const {
  ...
  inline IdType subId(
      const typename TriangleGrid::GridFamily::Traits::Codim<0>::Entity &entity,
