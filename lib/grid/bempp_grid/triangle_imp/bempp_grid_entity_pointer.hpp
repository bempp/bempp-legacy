...
namespace BemppGrid {
    ...
    class EntityPointerImp {
        ...
        public:
            ...
            typedef typename TriangleGrid::GridFamily::Traits::Codim<codim>::Entity Entity;
            ...
            bool equals(const EntityPointerImp<codim, const TriangleGrid>& other) const {
                ...
                return (other.level() == level()) &&
                    (TriangleGrid::entityIndex<codim>(*other.m_entity) == TriangleGrid::entityIndex<codim>(*m_entity));
