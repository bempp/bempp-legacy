...
// all static variables removed to allow use in parallel code
...
double xzabs_(double *zr, double *zi)
{
    /* System generated locals */
    double ret_val;
...
int xzexp_(double *ar, double *ai, double *br, double *bi)
{
    /* Local variables */
    double ca, cb, zm;
...
int xzlog_(double *ar, double *ai, double *br, double *bi, int *ierr)
{
    /* Initialized data */
...
int xzsqrt_(double *ar, double *ai, double *br, double *bi)
{
    /* Initialized data */
  ...
  int *nz, double *tol, double *elim, double *alim)
{
    ...
    double cspnr;
    double cwrkr[48]	/* was [16][3] */, sumdr;
