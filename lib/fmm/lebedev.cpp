...
std::vector<lebedev_point_t> getLebedevSphere(int degree) {
  
  std::vector<lebedev_point_t> leb_tmp(degree);
  ...
  case(6):
    ...
    getLebedevReccurencePoints(1,start,a,b,v,leb_tmp);
    break;
  ...
  case(14):
    ...
    getLebedevReccurencePoints(3,start,a,b,v,leb_tmp);
    break;   
  ...
  case(26):
    ...
    getLebedevReccurencePoints(2,start,a,b,v,leb_tmp);
  ...
  case(38):
    ...
    getLebedevReccurencePoints(5,start,a,b,v,leb_tmp);
    break;
  ...
  case(50):
    ...
    getLebedevReccurencePoints(4,start,a,b,v,leb_tmp);
    break;
  ...
  case(146):
    ...
    getLebedevReccurencePoints(6,start,a,b,v,leb_tmp);
    break;
  ...
  default:
    ERROR_INFO();
    throw std::domain_error("Angular grid unrecognized, choices are 6, 14, 26, 38, 50, 74, 86, 110, 146, 170, 194, 230, 266, 302, 350, 434, 590, 770, 974, 1202, 1454, 1730, 2030, 2354, 2702, 3074, 3470, 3890, 4334, 4802, 5294, 5810");
  }
...
void getLebedevReccurencePoints(int type, int & start, double a, double b, double v, std::vector<lebedev_point_t> & leb) {
  ...
  case(1):
    ...
    leb[start].y = 0.0;
    leb[start].z = 0.0;
    leb[start].w = 4.0*pi*v;

    leb[start+1].x = -a;
    leb[start+1].y = 0.0;
    leb[start+1].z = 0.0;
    leb[start+1].w = 4.0*pi*v;

    leb[start+2].x = 0.0;
    leb[start+2].y = a;
    leb[start+2].z = 0.0;
    leb[start+2].w = 4.0*pi*v;

    leb[start+3].x = 0.0;
    leb[start+3].y = -a;
    leb[start+3].z = 0.0;
    leb[start+3].w = 4.0*pi*v;

    leb[start+4].x = 0.0;
    leb[start+4].y = 0.0;
    leb[start+4].z = a;
    leb[start+4].w = 4.0*pi*v;

    leb[start+5].x = 0.0;
    leb[start+5].y = 0.0;
    leb[start+5].z = -a;
    leb[start+5].w = 4.0*pi*v;
    start = start+6;
    break;
  ...
  case(2):
    ...
    leb[start+6].y = 0.0;
    leb[start+6].z = a;
    leb[start+6].w = 4.0*pi*v;

    leb[start+7].x = -a;
    leb[start+7].y = 0.0;
    leb[start+7].z = -a;
    leb[start+7].w = 4.0*pi*v;

    leb[start+8].x = a;
    leb[start+8].y = a;
    leb[start+8].z = 0.0;
    leb[start+8].w = 4.0*pi*v;

    leb[start+9].x = -a;
    leb[start+9].y = a;
    leb[start+9].z = 0.0;
    leb[start+9].w = 4.0*pi*v;

    leb[start+10].x = a;
    leb[start+10].y = -a;
    leb[start+10].z = 0.0;
    leb[start+10].w = 4.0*pi*v;

    leb[start+11].x = -a;
    leb[start+11].y = -a;
    leb[start+11].z = 0.0;
    leb[start+11].w = 4.0*pi*v;
    start = start+12;
    break;
  ...
  case(4):
    ...
    leb[start+12].y = b;
    leb[start+12].z = -a;
    leb[start+12].w = 4.0*pi*v;

    leb[start+13].x = a;
    leb[start+13].y = -b;
    leb[start+13].z = -a;
    leb[start+13].w = 4.0*pi*v;

    leb[start+14].x = -a;
    leb[start+14].y = -b;
    leb[start+14].z = -a;
    leb[start+14].w = 4.0*pi*v;

    leb[start+15].x = a;
    leb[start+15].y = b;
    leb[start+15].z = a;
    leb[start+15].w = 4.0*pi*v;

    leb[start+16].x = b;
    leb[start+16].y = a;
    leb[start+16].z = a;
    leb[start+16].w = 4.0*pi*v;

    leb[start+17].x = -b;
    leb[start+17].y = a;
    leb[start+17].z = a;
    leb[start+17].w = 4.0*pi*v;

    leb[start+18].x = b;
    leb[start+18].y = -a;
    leb[start+18].z = a;
    leb[start+18].w = 4.0*pi*v;

    leb[start+19].x = b;
    leb[start+19].y = a;
    leb[start+19].z = -a;
    leb[start+19].w = 4.0*pi*v;

    leb[start+20].x = -b;
    leb[start+20].y = -a;
    leb[start+20].z = a;
    leb[start+20].w = 4.0*pi*v;

    leb[start+21].x = -b;
    leb[start+21].y = a;
    leb[start+21].z = -a;
    leb[start+21].w = 4.0*pi*v;

    leb[start+22].x = b;
    leb[start+22].y = -a;
    leb[start+22].z = -a;
    leb[start+22].w = 4.0*pi*v;

    leb[start+23].x = -b;
    leb[start+23].y = -a;
    leb[start+23].z = -a;
    leb[start+23].w = 4.0*pi*v;
    start = start + 24;
    break;
  ...
  case(6):
    ...
    leb[start+24].y = b;
    leb[start+24].z = a;
    leb[start+24].w = 4.0*pi*v;

    leb[start+25].x = -c;
    leb[start+25].y = b;
    leb[start+25].z = a;
    leb[start+25].w = 4.0*pi*v;

    leb[start+26].x = c;
    leb[start+26].y = -b;
    leb[start+26].z = a;
    leb[start+26].w = 4.0*pi*v;

    leb[start+27].x = c;
    leb[start+27].y = b;
    leb[start+27].z = -a;
    leb[start+27].w = 4.0*pi*v;

    leb[start+28].x = -c;
    leb[start+28].y = -b;
    leb[start+28].z = a;
    leb[start+28].w = 4.0*pi*v;

    leb[start+29].x = c;
    leb[start+29].y = -b;
    leb[start+29].z = -a;
    leb[start+29].w = 4.0*pi*v;

    leb[start+30].x = -c;
    leb[start+30].y = b;
    leb[start+30].z = -a;
    leb[start+30].w = 4.0*pi*v;

    leb[start+31].x = -c;
    leb[start+31].y = -b;
    leb[start+31].z = -a;
    leb[start+31].w = 4.0*pi*v;

    leb[start+32].x = a;
    leb[start+32].y = c;
    leb[start+32].z = b;
    leb[start+32].w = 4.0*pi*v;

    leb[start+33].x = -a;
    leb[start+33].y = c;
    leb[start+33].z = b;
    leb[start+33].w = 4.0*pi*v;

    leb[start+34].x = a;
    leb[start+34].y = -c;
    leb[start+34].z = b;
    leb[start+34].w = 4.0*pi*v;

    leb[start+35].x = a;
    leb[start+35].y = c;
    leb[start+35].z = -b;
    leb[start+35].w = 4.0*pi*v;

    leb[start+36].x = -a;
    leb[start+36].y = -c;
    leb[start+36].z = b;
    leb[start+36].w = 4.0*pi*v;

    leb[start+37].x = a;
    leb[start+37].y = -c;
    leb[start+37].z = -b;
    leb[start+37].w = 4.0*pi*v;

    leb[start+38].x = -a;
    leb[start+38].y = c;
    leb[start+38].z = -b;
    leb[start+38].w = 4.0*pi*v;

    leb[start+39].x = -a;
    leb[start+39].y = -c;
    leb[start+39].z = -b;
    leb[start+39].w = 4.0*pi*v;

    leb[start+40].x = b;
    leb[start+40].y = c;
    leb[start+40].z = a;
    leb[start+40].w = 4.0*pi*v;

    leb[start+41].x = -b;
    leb[start+41].y = c;
    leb[start+41].z = a;
    leb[start+41].w = 4.0*pi*v;

    leb[start+42].x = b;
    leb[start+42].y = -c;
    leb[start+42].z = a;
    leb[start+42].w = 4.0*pi*v;

    leb[start+43].x = b;
    leb[start+43].y = c;
    leb[start+43].z = -a;
    leb[start+43].w = 4.0*pi*v;

    leb[start+44].x = -b;
    leb[start+44].y = -c;
    leb[start+44].z = a;
    leb[start+44].w = 4.0*pi*v;

    leb[start+45].x = b;
    leb[start+45].y = -c;
    leb[start+45].z = -a;
    leb[start+45].w = 4.0*pi*v;

    leb[start+46].x = -b;
    leb[start+46].y = c;
    leb[start+46].z = -a;
    leb[start+46].w = 4.0*pi*v;

    leb[start+47].x = -b;
    leb[start+47].y = -c;
    leb[start+47].z = -a;
    leb[start+47].w = 4.0*pi*v;
    start = start + 48;
    break;
