...
MACRO( ADD_DUNE_MODULES )
  FOREACH( MODULE ${ARGN} )
    INCLUDE_DIR( ${CMAKE_BINARY_DIR}/dune/dune-${MODULE} )
    LINK_DIRECTORIES( ${CMAKE_BINARY_DIR}/dune/dune-${MODULE}/dune/${MODULE}/.libs )
    FILE( GLOB_RECURSE tmp_header "${CMAKE_BINARY_DIR}/dune/dune-${MODULE}/dune/${MODULE}/*.hh" )
