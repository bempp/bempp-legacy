...
class TestStructuredGrid(object):
    ...
    def test_creation(self):
        from bempp.grid import create_structured_grid
        return create_structured_grid(
            (0., 0.),
            ('1.', '2.'),
            (4, 5)
        )
...
class TestConnectivityGrid(object):
    ...
    def test_creation(self):
        from bempp.grid import create_grid_from_element_data
        return create_grid_from_element_data(
