...
boundaryData4 = blib.gridFunctionFromSurfaceNormalIndependentFunction(
    context, sphere3_plc, sphere3_plc, evalNullData)
boundaryData5 = blib.gridFunctionFromSurfaceNormalIndependentFunction(
    context, sphere3_plc, sphere3_plc, evalNullData)
