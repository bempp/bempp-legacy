...
from bempp.operators.laplace.laplace cimport c_laplace3dSingleLayerBoundaryOperator
from bempp.operators.laplace.laplace cimport c_laplace3dDoubleLayerBoundaryOperator
from bempp.utils.byte_conversion import convert_to_bytes
from bempp.utils.enum_types cimport symmetry_mode
from bempp.utils cimport complex_float, complex_double

def single_layer(ParameterList parameterList,
...
def double_layer(ParameterList parameterList,
        Space domain, Space range, Space dual_to_range,
