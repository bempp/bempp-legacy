...
class TestModifiedHelmholtz(TestCase):
    ...
    def setUp(self):
        ...
        self._lin_space = bempp.function_space(grid, "P", 1)
        self._const_space = bempp.function_space(grid, "DP", 0)

    def test_compound_hypersingular_agrees_with_standard_hypersingular_operator(self):
        from bempp.operators.boundary.modified_helmholtz import hypersingular
        import numpy as np
        ...
        mat1 = bempp.as_matrix(standard_hypersingular)
        mat2 = bempp.as_matrix(compound_hypersingular)
