...
%feature("pythonappend") Bempp::PythonSurfaceNormalIndependentFunctor_float32::PythonSurfaceNormalIndependentFunctor_float32(PyObject *pyFunc,int argumentDimension, int resultDimension)
 %{
self._valueType="float32"
  %}
%feature("pythonappend") Bempp::PythonSurfaceNormalIndependentFunctor_float64::PythonSurfaceNormalIndependentFunctor_float64(PyObject *pyFunc,int argumentDimension, int resultDimension)
 %{
self._valueType="float64"
  %}
%feature("pythonappend") Bempp::PythonSurfaceNormalIndependentFunctor_complex64::PythonSurfaceNormalIndependentFunctor_complex64(PyObject *pyFunc,int argumentDimension, int resultDimension)
 %{
self._valueType="complex64"
  %}
%feature("pythonappend") Bempp::PythonSurfaceNormalIndependentFunctor_complex128::PythonSurfaceNormalIndependentFunctor_complex128(PyObject *pyFunc,int argumentDimension, int resultDimension)
 %{
...
namespace Bempp{
class PythonSurfaceNormalIndependentFunctor_## NPY_NAME : public SurfaceNormalIndependentFunctor< TYPE >
{
 public:
  PythonSurfaceNormalIndependentFunctor_## NPY_NAME(PyObject *pyFunc,int argumentDimension, int resultDimension) :
...
def surfaceNormalIndependentFunctor(fun,valueType='float64',argumentDimension=3,resultDimension=1):
    ...
    base=None
    if dtype=='float32':
        functor=PythonSurfaceNormalIndependentFunctor_float32
    elif dtype=='float64':
        functor=PythonSurfaceNormalIndependentFunctor_float64
    elif dtype=='complex64':
        functor=PythonSurfaceNormalIndependentFunctor_complex64
    elif dtype=='complex128':
        functor=PythonSurfaceNormalIndependentFunctor_complex128
