...
class TestAssembler(TestCase):
    def setUp(self):
        ...
        rt_space = bempp.function_space(grid, "RT", 0)

        self._real_operator = bempp.operators.boundary.laplace.single_layer(space, space, space)
        self._complex_operator = bempp.operators.boundary.maxwell.electric_field(rt_space, 1)
    ...
    def tearDown(self):
        ...
        bempp.global_parameters = bempp.common.global_parameters()

    def test_assemble_complete_dense_real_operator(self):
        from bempp import as_matrix, assemble_dense_block
        import numpy as np
        import bempp
        ...
        actual = as_matrix(assemble_dense_block(self._real_operator, bempp.ALL, bempp.ALL,
    ...
    def test_assemble_complete_dense_complex_operator(self):
        ...
        actual = as_matrix(assemble_dense_block(self._complex_operator, bempp.ALL, bempp.ALL,
                                                operator.domain, operator.dual_to_range))
