...
class PythonDomainIndexDependentFunctor
{
public:
    typedef ValueType_ ValueType;
    typedef typename ScalarTraits<ValueType>::RealType CoordinateType;

    PythonDomainIndexDependentFunctor(
                  ...
                  arma::Col<ValueType>& result_) const
    {
        ...
        // Call into Python
        PyObject* pyReturnVal = PyObject_CallFunctionObjArgs(m_pyFunc, pyPoint, pyDomainIndex, NULL);
        if (!pyReturnVal) {
            Py_XDECREF(pyPoint);
...
BEMPP_INSTANTIATE_SYMBOL_TEMPLATED_ON_VALUE(PythonDomainIndexDependentFunctor);
