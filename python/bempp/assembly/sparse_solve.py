...
class SparseSolve(object):
    ...
    def __init__(self,op, use_lsmr=False, atol=1E-6, btol=1E-6,
        ...
        if use_lsmr:
            self._solve_fun = lambda x: lsmr(op, x, atol=atol, btol=btol,
                    conlim=conlim, maxiter=maxiter, show=show)[0]
        else:
