...
class TestMaxwellSpaces(TestCase):
    ...
    def test_nedelec_space_is_tangential_conforming(self):
        ...
        for dof_index in range(space.global_dof_count):
            ...
            tangent_0 = edge_0.geometry.corners[:,1] - edge_0.geometry.corners[:,0]
            tangent_1 = edge_1.geometry.corners[:,1] - edge_1.geometry.corners[:,0]
            ...
            inverse_jacob_transpose_0 = elem_0.geometry.jacobian_inverses_transposed(p_0)[0]
            inverse_jacob_transpose_1 = elem_1.geometry.jacobian_inverses_transposed(p_1)[0]
    ...
    def test_rt_space_is_normal_conforming(self):
        ...
        for dof_index in range(space.global_dof_count):
            ...
            elem_val_0 = jacob_transpose_0.T.dot(val_0) / elem_0.geometry.integration_elements(p_0)[0]
            elem_val_1 = jacob_transpose_1.T.dot(val_1) / elem_1.geometry.integration_elements(p_1)[0]
