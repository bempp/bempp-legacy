...
def menger_sponge(h=0.1, level=2):
    ...
    for i in range(level):
        ...
        for c in cubes:
            ...
            new_cubes.append((c[0], n[15], n[19], n[5], n[1], n[14], n[18], n[
                4], (c[8][0], c[8][1],
                     False, False, c[8][4], False)))
            new_cubes.append((n[31], c[1], n[49], n[35], n[30], n[45], n[48], n[
                34], (c[8][0], c[8][1], c[8][2],
                      False, False, False)))
            new_cubes.append((n[39], n[53], c[2], n[43], n[38], n[52], n[55], n[
                42], (c[8][0], False, c[8][2],
                      c[8][3], False, False)))
            new_cubes.append((n[9], n[23], n[27], c[3], n[8], n[22], n[26], n[
                11], (c[8][0], False, False,
                      c[8][3], c[8][4], False)))
            new_cubes.append((n[5], n[19], n[23], n[9], n[4], n[18], n[22], n[
                8], (c[8][0], False, True, False, c[8][4], True)))
            new_cubes.append((n[15], n[31], n[35], n[19], n[14], n[30],
                              n[34], n[18], (c[8][0], c[8][1],
                                             False, True, False, True)))
            new_cubes.append((n[35], n[49], n[53], n[39],
                              n[34], n[48], n[52], n[
                                  38], (c[8][0], False, c[8][2],
                                        False, True, True)))
            new_cubes.append((n[23], n[39], n[43], n[27], n[22], n[38], n[42],
                              n[26], (c[8][0], True, False,
                                      c[8][3], False, True)))

            new_cubes.append((n[1], n[14], n[18], n[4], n[0], n[13], n[17], n[
                3], (False, c[8][1], True, True, c[8][4], False)))
            new_cubes.append((n[30], n[45], n[48], n[34], n[29], n[44],
                              n[47], n[33],
                              (False, c[8][1], c[8][2], True, True, False)))
            new_cubes.append((n[38], n[52], n[55], n[42], n[37], n[51], n[54],
                              n[41],
                              (False, True, c[8][2], c[8][3], True, False)))
            new_cubes.append((n[8], n[22], n[26], n[11], n[7], n[21], n[25], n[
                10], (False, True, True, c[8][3], c[8][4], False)))

            new_cubes.append((n[0], n[13], n[17], n[3], c[4], n[12], n[16], n[
                2], (False, c[8][1], False, False,
                     c[8][4], c[8][5])))
            new_cubes.append((n[29], n[44], n[47], n[33], n[28], c[5], n[46], n[
                32], (False, c[8][1], c[8][2], False,
                      False, c[8][5])))
            new_cubes.append((n[37], n[51], n[54], n[41], n[36], n[50], c[6], n[
                40], (False, False, c[8][2],
                      c[8][3], False, c[8][5])))
            new_cubes.append((n[7], n[21], n[25], n[10], n[6], n[20], n[24], c[
                7], (False, False, False, c[8][3],
                     c[8][4], c[8][5])))
            new_cubes.append((n[3], n[17], n[21], n[7], n[2], n[16], n[20], n[
                6], (True, False, True, False, c[8][4], c[8][5])))
            new_cubes.append((n[13], n[29], n[33],
                              n[17], n[12], n[28], n[32], n[16],
                              (True, c[8][1], False, True, False, c[8][5])))
            new_cubes.append((n[33], n[47], n[51], n[37], n[32], n[46], n[50],
                              n[36], (True, False, c[8][2],
                                      False, True, c[8][5])))
            new_cubes.append((n[21], n[37], n[41], n[25], n[20],
                              n[36], n[40], n[24],
                              (True, True, False, c[8][3], False, c[8][5])))
        cubes = new_cubes
    for i, p in enumerate(points):
        geo += "Point(" + str(1 + i) + \
            ") = {" + str(p[0]) + "," + str(p[1]) + "," + str(p[2]) + ",lc};\n"
    ...
    for n, t in enumerate(cubes):
        edges = []
        for a in [(0, 1), (1, 2), (2, 3), (3, 0), (0, 4), (1, 5),
        ...
        if t[8][0]:
            geo += ("Line Loop(" + str(loop_n) + ") = { " + str(edges[0]) +
                    ", " + str(edges[1]) + ", " + str(edges[2]) +
                    ", " + str(edges[3]) + "};\n")
            loop_n += 1
        if t[8][1]:
            geo += ("Line Loop(" + str(loop_n) + ") = {" + str(-edges[0])
                    + ", " + str(edges[4]) + ", " +
                    str(edges[8]) + "," + str(-edges[5]) + "};\n")
            loop_n += 1
        if t[8][2]:
            geo += ("Line Loop(" + str(loop_n) + ") = {" + str(-edges[1]) +
                    ", " + str(edges[5]) + ", " +
                    str(edges[9]) + "," + str(-edges[6]) + "};\n")
            loop_n += 1
        if t[8][3]:
            geo += ("Line Loop(" + str(loop_n) + ") = {" + str(-edges[2]) +
                    ", " + str(edges[6]) + ", " + str(edges[10]) +
                    "," + str(-edges[7]) + "};\n")
            loop_n += 1
        if t[8][4]:
            geo += ("Line Loop(" + str(loop_n) + ") = {" + str(-edges[3]) +
                    ", " + str(edges[7]) + ", " + str(edges[11]) + "," +
                    str(-edges[4]) + "};\n")
            loop_n += 1
        if t[8][5]:
            geo += ("Line Loop(" + str(loop_n) + ") = {" + str(-edges[11]) +
                    "," + str(-edges[10]) + "," +
                    str(-edges[9]) + "," + str(-edges[8]) + "};\n")
            loop_n += 1
