...
BEMPP_FORWARD_DECLARE_CLASS_TEMPLATED_ON_VALUE(discreteOperatorToPreconditioner)
...
BEMPP_INSTANTIATE_SYMBOL_TEMPLATED_ON_VALUE(discreteOperatorToPreconditioner)
