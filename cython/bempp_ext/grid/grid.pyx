...
from bempp_ext.grid.grid_view cimport _grid_view_from_unique_ptr
from bempp_ext.grid.id_set cimport IdSet
import numpy as _np
...
cdef extern from "bempp_ext/grid/py_sphere.hpp" namespace "Bempp":
